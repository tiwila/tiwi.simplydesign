...
export function WhyMoment({
  ...
  accentColor?: "accent" | "sage" | "terracotta" | "mint";
}) {
          ...
          backgroundImage:
            accentColor === "sage"
              ...
              : accentColor === "terracotta"
                ...
                : accentColor === "mint"
                  ? "var(--texture-noise), linear-gradient(var(--talksai-mint-soft), var(--talksai-mint-soft))"
                  : "var(--texture-noise), linear-gradient(var(--color-accent-light), var(--color-accent-light))",
          backgroundSize: "140px 140px, 100% 100%"
        }}
      >
        <span
          className={`absolute left-0 top-0 h-full w-[3px] origin-top transition-transform duration-[400ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
            accentColor === "sage"
              ? "bg-sage"
              : accentColor === "terracotta"
                ? "bg-terracotta"
